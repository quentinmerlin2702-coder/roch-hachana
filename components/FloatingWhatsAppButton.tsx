...
/**
 * Bouton WhatsApp flottant, visible sur toutes les pages (bas de l'écran).
 * Lien direct wa.me vers le numéro du vendeur : aucune API WhatsApp,
 * aucun envoi automatique. Le client doit lui-même appuyer sur "Envoyer"
 * une fois dans WhatsApp.
 */
export default function FloatingWhatsAppButton() {
  const message = "Bonjour ! J'ai une question sur vos corbeilles de Roch Hachana.";
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-md transition hover:brightness-95 active:scale-95 sm:bottom-6 sm:right-6"
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 32 32"
